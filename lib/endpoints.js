import {
  ...
  CalendarClock, Wallet, CalendarCheck, MessageSquare,
  UserPlus, Ticket, Video, Map
} from 'lucide-react';
...
export const healthEndpoints = [
  ...
  },
  {
    ...
    module: 'enrollment',
    description: 'Child enrollment system',
    icon: UserPlus
  },
  {
    name: 'Tickets Module',
  ...
  {
    name: 'Success Roadmap Module',
    path: '/success-roadmap/health',
    module: 'success-roadmap',
