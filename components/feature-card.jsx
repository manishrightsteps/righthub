...
export function FeatureCard({ title, items, icon: Icon, color, delay = 0 }) {
  return (
    <motion.div
    ...
    >
      ...
      <ul className="space-y-2">
        {items.map((item, idx) => (
          ...
          >
            <div className={`${colorMap[color].checkBg} w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 group-hover/item:scale-105 transition-transform`}>
